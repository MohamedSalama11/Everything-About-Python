...
# 7- Before you perform update and delete operations be sure selecting the right data you want 
...
# 20- SELECT column_name FROM table_name                                                                  => This means give me only the data in this columns name

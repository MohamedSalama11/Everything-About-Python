# Privacy   :- Means that no one knows what you are doing, like if you entered your house people can see that you entered you house but they don't know what you are doing inside.
# Anonymity :- Means that people can see what you're doing but they don't know who you are

# Privacy Can't be achieved easily on the interent because the internet not owned by you, so if you visit a website the ISP (internet service provider) will know
...
# 3- Qubes with whonix => Best Way and qubes is an operating system and whonix is a gateway and it's very secure
...
# 7- With TOR borwser all the traffics sent through the browser it is in the tor network.
...
# When you download the TOR browser from the torproject website you must download the signature file and then download the Gpg4win program to see if the signature matches
# the tor app you just downloaded because the file you downloaded could be modified by the ISP or a hacker.
